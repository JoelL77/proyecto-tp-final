...
import { OptimizadorListaService } from '@modules/optimizador-lista/services/optimizador-lista.service';
import { CardOferta } from '@shared/components/card-oferta/card-oferta';
import { Oferta } from '@shared/models/oferta';
import { ProductoCard } from '@shared/models/productoCard';
import { SharedService } from '../../../../api/services/shared/shared.service';
...
@Component({
  ...
  imports: [CardOferta, CommonModule, Mapa,RouterLink,NgbCarousel,QRCodeComponent],
  templateUrl: './optimizador-lista.html',
  styleUrl: './optimizador-lista.css'
})
export class OptimizadorLista {

  @ViewChild(CardOferta) appCardOfertaComponent!: CardOferta;
  bResumen = false;
  bEscenarios = true;
  bEstaLogueado = false;
