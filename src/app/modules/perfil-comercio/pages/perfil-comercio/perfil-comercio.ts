...
import { PerfilComercioService } from '@modules/perfil-comercio/service/perfil-comercio.service';
...
@Component({
  ...
  imports: [CardOferta,CommonModule,FormsModule,ReactiveFormsModule],
  templateUrl: './perfil-comercio.html',
  styleUrl: './perfil-comercio.css'
})
export class PerfilComercio {
