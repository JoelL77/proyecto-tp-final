...
import { ConsultaEventoService } from '@modules/consulta-evento/services/consulta-evento.service';
import { Color } from '@shared/enums/enums/Color.enum';
import { EventoTipo } from '@shared/enums/enums/Evento.enum';
import { Medida } from '@shared/enums/enums/Medida.enum';
import { PersonajeEvento } from '@shared/enums/enums/PersonajeEvento.enum';
...
@Component({
  ...
  imports: [CommonModule, Mapa,FormsModule],
  templateUrl: './consulta-evento.html',
  styleUrl: './consulta-evento.css'
})
export class ConsultaEvento {
